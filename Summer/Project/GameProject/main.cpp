...
#include "Game/EnemyM1.h"
#include "Game/EnemyM2.h"
#include "Game/Enemy_Rare.h"
#include "Game/Enemy_RareM.h"
...
void Init(void)
{
	...
	ADD_RESOURCE("Enemy_Rare", CImage::CreateImage("Image/Enemy.png", enemy_anim_data, 64, 64));
	...
	ADD_RESOURCE("Laser", CImage::CreateImage("Image/Laser.png", effect_laser_anim_data, 64, 64));
	ADD_RESOURCE("Field", CImage::CreateImage("Image/Field.png"));
	ADD_RESOURCE("Title", CImage::CreateImage("Image/Title.png"));
	ADD_RESOURCE("UI", CImage::CreateImage("Image/number.png"));
	//-----------------------------------------------------
	//初期化の命令を書く
	//ゲーム起動時に一度だけ呼ばれる
	//-----------------------------------------------------
